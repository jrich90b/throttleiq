...
export async function parsePurchaseDeliveryLogisticsWithLLM(args: {
  ...
  const prompt = [
    ...
    "- In active purchase/delivery context, short operational requests for VIN, lift info, whether a dealer trade is done, a phone call, or selected accessories are delivery_progress.",
