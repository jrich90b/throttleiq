...
// ── Console Copilot (manager "Ask AI", read-only — docs/console_copilot_phase1.md) ──────────
// Answers are grounded on the deterministic snapshot from domain/copilotInsights.ts; the
// model explains and selects, it never computes counts of its own.
