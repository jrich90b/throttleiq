...
export async function parseInventoryEntitiesWithLLM(args: {
  ...
  const voiceExamples = [
    ...
    'input: "Customer: how about a tri glide instead?" output: {"model":"Tri Glide","year":0,"year_min":0,"year_max":0,"color":"","trim":"","min_price":0,"max_price":0,"monthly_budget":0,"down_payment":0,"confidence":0.95}',
    'input: "Customer: how about a triglycerides instead?" output: {"model":"Tri Glide","year":0,"year_min":0,"year_max":0,"color":"","trim":"","min_price":0,"max_price":0,"monthly_budget":0,"down_payment":0,"confidence":0.93}',
